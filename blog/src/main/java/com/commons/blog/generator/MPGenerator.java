...
public class MPGenerator {
    ...
    private static final String MYSQL_PASSWORD = "jt4sZdaR7AdDYDXe";

    private static final String MYSQL_USERNAME = "csp";

    private static final String MYSQL_URL = "jdbc:mysql://101.42.35.190:3306/tencentcloud?autoReconnect=true&useUnicode=true&characterEncoding=UTF8&allowPublicKeyRetrieval=true&useSSL=false&tcpKeepAlive=true&autoReconnect=true&serverTimezone=Asia/Shanghai";

    private static final String MYSQL_TABLE_PREFIX = "blog_";
...
//                        .logicDeleteColumnName("isDeleted") //逻辑删除字段名
                                ...
                                .superClass(BaseSourceEntity.class)
                                .enableFileOverride()

                                // mapper、service、controller不覆盖
                                // mapper 策略配置
                                .mapperBuilder()
