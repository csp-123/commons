...
// 使用指数曲线调整相似度结果
    ...
    public static int getHammingDistance(BufferedImage image1, BufferedImage image2) throws IOException {
...
// long start = System.currentTimeMillis();
    ...
    public static String getHash(BufferedImage imageFile) throws IOException {
        ...
        imageFile = resize(imageFile, size, size);
        ...
        for (int x = 0; x < imageFile.getWidth(); x++) {
            ...
            for (int y = 0; y < imageFile.getHeight(); y++) {
                ...
                vals[x][y] = getBlue(imageFile, x, y);
